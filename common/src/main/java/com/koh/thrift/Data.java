...
public class Data implements org.apache.thrift.TBase<Data, Data._Fields>, java.io.Serializable, Cloneable, Comparable<Data> {
  ...
  private static final org.apache.thrift.protocol.TField SUB_DATA_FIELD_DESC = new org.apache.thrift.protocol.TField("subData", org.apache.thrift.protocol.TType.STRUCT, (short)3);
  ...
  public SubData subData; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ID((short)1, "id"),
    NAME((short)2, "name"),
    SUB_DATA((short)3, "subData");
  ...
  static {
    ...
    tmpMap.put(_Fields.SUB_DATA, new org.apache.thrift.meta_data.FieldMetaData("subData", org.apache.thrift.TFieldRequirementType.DEFAULT,
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, SubData.class)));
  ...
  public Data(Data other) {
    ...
    if (other.isSetSubData()) {
      this.subData = new SubData(other.subData);
    }
  }
  ...
  public Data setSubData(SubData subData) {
    this.subData = subData;
    return this;
  }

  public void unsetSubData() {
    this.subData = null;
  }

  /** Returns true if field subData is set (has been assigned a value) and false otherwise */
  public boolean isSetSubData() {
    return this.subData != null;
  }

  public void setSubDataIsSet(boolean value) {
    if (!value) {
      this.subData = null;
    }
  }
  ...
  public boolean equals(Data that) {
    ...
    boolean this_present_subData = true && this.isSetSubData();
    boolean that_present_subData = true && that.isSetSubData();
    if (this_present_subData || that_present_subData) {
      if (!(this_present_subData && that_present_subData))
        return false;
      if (!this.subData.equals(that.subData))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSubData()) ? 131071 : 524287);
    if (isSetSubData())
      hashCode = hashCode * 8191 + subData.hashCode();
  ...
  public int compareTo(Data other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSubData()).compareTo(other.isSetSubData());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubData()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.subData, other.subData);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class DataStandardScheme extends org.apache.thrift.scheme.StandardScheme<Data> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // SUB_DATA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.subData = new SubData();
              struct.subData.read(iprot);
              struct.setSubDataIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Data struct) throws org.apache.thrift.TException {
      ...
      if (struct.subData != null) {
        oprot.writeFieldBegin(SUB_DATA_FIELD_DESC);
        struct.subData.write(oprot);
        oprot.writeFieldEnd();
      }
